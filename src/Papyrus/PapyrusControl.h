...
namespace PapyrusControl {
	...
	std::string GetControlString(Controls a_control) {
		switch (a_control) {
		case Controls::Up: return "UP";
		case Controls::Down: return "DOWN";
		case Controls::Left: return "LEFT";
		case Controls::Right: return "RIGHT";
		case Controls::Toggle: return "TOG";
		case Controls::Yes: return "YES";
		case Controls::No: return "NO";
		case Controls::Menu: return "MENU";
		default: return "";
		}
	}
